...
<details>
<summary>Readme Cipher Dialecto Brujo Oculto</summary>
...
A raíz de esto, comienza una búsqueda de contextos de la vida diaria en la que se pueda aplicar este método. Se toma como referencia la agenda chilena 'Pascualina', cuya protagonista es un personaje femenino que creó un abecedario especial (dialecto brujo) con símbolos que reemplazaban las letras del alfabeto y permitía a les usuarios de la agenda escribir su diario de vida en clave.

## 2. Usuario objetivo

La idea de nuestro producto es permitir que usuarios con alfabetización digital de todas las edades (niños de 12 a 99 años), y que quieran divertirse enviando mensajes secretos a sus contactos (por mensajería instantánea en Whatsapp, Telegram, Instagram y Facebook), puedan entrar a nuestra aplicación y encriptar sus textos, copiarlos y pegarlos en sus redes sociales favoritas.
...
El prototipo inicial fue realizado en formato de baja fidelidad y comprendía 3 páginas, las que finalmente se condensaron en 2. El diseño final fue desarrollado para el uso de forma muy intuitiva, de fácil entender y de diseño atractivo para los usuarios. Los colores y las imágenes son característicos de la agenda Pascualina, con la cual nos inspiramos. 

## 4. Experiencia de usuario


![](src/img/Pagina-1.png)
